...
# Form implementation generated from reading ui file 'EnviaInfoMain.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(571, 428)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.txt_nombre = QtWidgets.QLineEdit(self.centralwidget)
        self.txt_nombre.setGeometry(QtCore.QRect(70, 130, 441, 71))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.btn_saludar.setGeometry(QtCore.QRect(210, 250, 141, 51))
        font = QtGui.QFont()
        ...
        self.label.setGeometry(QtCore.QRect(70, 50, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Tu Nombre:"))
